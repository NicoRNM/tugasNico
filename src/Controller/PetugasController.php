...
$petugas = $this->paginate($this->Petugas->find('all',
['conditions' => ['level !=' => 'admin']]));
}else{
$petugas = $this->Petugas->find('all', ['conditions' =>
['id =' => $id]]);
...
$this->Flash->error(__('The petuga could not be deleted.
Please, try again.'));
}
} else {
$this->Flash->error(__('Mohon maaf anda tidak bisa menghapus
akun anda sendiri, silahkan menghubungi admin untuk konfirmasi hapus data
pengguna'));
}
return $this->redirect(['action' => 'index']);
}
