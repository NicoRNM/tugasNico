                ...
                <?php foreach ($tanggapan as $tanggapan) : ?>
                    <tr>
                        ...
                        <td class="actions">
                            ...
                            <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $tanggapan->id], ['class' => 'btn btn-xs btn-outline-danger', 'escape' => false, 'confirm' => __('Are you sure you want to delete # {0}?', $tanggapan->id_tanggapan)]) ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </tbody>
